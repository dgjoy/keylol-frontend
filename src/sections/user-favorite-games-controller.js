(function () {
    class UserFavoriteGamesController {
        constructor () {
            this.cards = [
                {
            ...
            this.gameMiddlePart = this.cards[0];
            this.gameLeftPart = [];
            this.gameRightPart = [];
            if (this.cards) {
    ...
    keylolApp.component('userFavoriteGames', {
        templateUrl: 'src/sections/user-favorite-games.html',
        controller: UserFavoriteGamesController,
        controllerAs: 'userFavoriteGames',
        bindings: {
            theme: '<',
        },
    });
