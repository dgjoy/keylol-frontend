(function () {
    class SteamCnRegistrationController {
        constructor(close, $scope, $timeout, notification, $http, utils, union, $q, apiEndpoint, $httpParamSerializerJQLike, $location, $state, window, steamCn) {
            $.extend(this,{
                close,
                notification,
                $http,
            ...
            this.phase = '添加好友'; // 添加好友,发送验证码,连接成功,填写表单
            this.conn = null;
            ...
            this.conn = {
                ...
                vm: {
                    ...
                    AvatarImage: '',
                    SteamProfileName: '',
                    steamCnUserName: steamCn.userName,
                    steamCnPassword: steamCn.password,
                    email: steamCn.email,
                },
                code: '',
                botSteamId64: '',
    ...
    keylolApp.controller('SteamCnRegistrationController', SteamCnRegistrationController);
}());
