(function () {
    ...
    keylolApp.constant('messageTypes', {
        ...
        activityLike: {
            ...
            name: '认可你的文章',
            getName(message) {
                return `认可你的文章<a href="activity/${message.acitivityAuthorIdCode}/${message.acitivitySidForAuthor}">「${missiveTextReduce(message.activityContent, 14)}」</a>`;
            },
            getSummary (message) {
        ...
        activityCommentLike: {
            ...
            name: '认可你的评论',
            getName(message) {
                const link = `activity/${message.acitivityAuthorIdCode}/${message.acitivitySidForAuthor}`;
